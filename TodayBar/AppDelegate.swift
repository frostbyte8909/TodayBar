...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var calendarStore = CalendarStore(settings: settingsState, accountManager: accountManager)
    lazy var reminderStore = ReminderStore(settings: settingsState, accountManager: accountManager)
    ...
    func showPopover(_ sender: Any?) {
        if let button = statusItem.button {
            ...
            calendarStore.fetchEvents(settings: settingsState, accountManager: accountManager)
    ...
    func showContextMenu() {
        ...
        menu.addItem(NSMenuItem(title: "Import Calendar (.ics)...", action: #selector(importCalendar), keyEquivalent: "i"))
    ...
    @objc func importCalendar() {
        ImportManager.promptForImport()
    }
